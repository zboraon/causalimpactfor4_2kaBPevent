  #adapted from http://sisifospage.tech/2017-10-30-forecasting-bsts.html
  ...
  library("RCurl")
  library("devtools")
  source_url("https://raw.githubusercontent.com/zboraon/causalimpactfor4_2kaBPevent/master/functions/loop_4_2ka_BP.R") #add the loop_4_2ka_BP.R function to source
